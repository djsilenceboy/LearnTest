...
public class PolicyException extends java.lang.Exception{
    ...
    private com.djs.learn.wsclient.wap_push.WapPushServiceStub.PolicyExceptionE faultMessage;
    ...
    public void setFaultMessage(com.djs.learn.wsclient.wap_push.WapPushServiceStub.PolicyExceptionE msg){
       faultMessage = msg;
    }
    
    public com.djs.learn.wsclient.wap_push.WapPushServiceStub.PolicyExceptionE getFaultMessage(){
       return faultMessage;
    }
}
