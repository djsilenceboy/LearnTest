...
public class ItemDaoImplD implements ItemDao
{
	...
	public void save( Item item )
	{
		...
		SimpleJdbcInsert simpleJdbcInsert =
		                                    new SimpleJdbcInsert( jdbcTemplate ).withTableName( "TEST_ITEM" ).usingColumns( "SEQ_ID", "ITEM_NAME",
		                                                                                                                    "DESCRIPTION" );
	...
	public List<Item> query( String itemName )
	{
		...
		SimpleJdbcCall simpleJbdcCall =
		                                new SimpleJdbcCall( jdbcTemplate )
		                                        .withProcedureName( "TEST_GET_ITEMS" )
		                                        .withoutProcedureColumnMetaDataAccess()
		                                        .useInParameterNames( "itemName" )
		                                        .declareParameters( new SqlParameter( "itemName", Types.VARCHAR ),
		                                                            new SqlOutParameter( "itemList", OracleTypes.CURSOR ) )
