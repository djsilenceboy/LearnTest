...
public class AppTest
{
	...
	public void testGreeting()
	{
		...
		appContext = new ClassPathXmlApplicationContext( "greeting.xml" );
	...
	public void testKnight()
	{
		...
		// Notes: AOP doesn't work while using XmlBeanFactory!
		appContext = new ClassPathXmlApplicationContext( "knight.xml" );
	...
	public void testMusic()
	{
		...
		// Notes: AOP doesn't work while using XmlBeanFactory!
		appContext = new ClassPathXmlApplicationContext( "music.xml" );
	...
	public void testDbHibernate()
	{
		...
		// Notes: AOP doesn't work while using XmlBeanFactory!
		appContext = new ClassPathXmlApplicationContext( new String []
		{ "db_datasource.xml", "db_hibernate.xml", "db_log.xml" } );
