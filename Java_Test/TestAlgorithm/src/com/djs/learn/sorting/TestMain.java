...
public class TestMain
{
	public static void main(String[] args){
		Integer[][] sampleData =
		                         {{11, 99, 33, 55, 77, 66, 22, 33, 88, 44, 11}, {11, 4, 99, 33, 8, 55, 9, 33, 77, 2, 3, 66, 11, 5, 22, 6, 1, 88, 7, 4, 44},
		                          {88, 88, 88, 88, 88, 88, 88, 88, 88}};

		SortingInterface[] sortingMethods =
		                                    new SortingInterface[]{new BubbleSort(), new BucketSort(), new HeapSort(), new HeapSort2(), new InsertionSort(),
		...
		for (Integer[] data : sampleData) {
			...
			for (SortingInterface sortingMethod : sortingMethods) {
				...
				Integer[] sortedData = sortingMethod.sort(data, output);
