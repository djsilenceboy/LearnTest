...
============================================================
A: T <dj.test.javalang.generics.SampleGeneric$SampleTypeB> = dj.test.javalang.generics.SampleGeneric$SampleTypeB@2a139a55
B: T <dj.test.javalang.generics.SampleGeneric$SampleTypeB> = dj.test.javalang.generics.SampleGeneric$SampleTypeB@15db9742
B: T <dj.test.javalang.generics.SampleGeneric$SampleTypeB> = dj.test.javalang.generics.SampleGeneric$SampleTypeB@6d06d69c
B: T <dj.test.javalang.generics.SampleGeneric$SampleTypeB> = dj.test.javalang.generics.SampleGeneric$SampleTypeB@7852e922
C: T <dj.test.javalang.generics.SampleGeneric$SampleTypeB> = dj.test.javalang.generics.SampleGeneric$SampleTypeB@4e25154f
C: T <dj.test.javalang.generics.SampleGeneric$SampleTypeB> = dj.test.javalang.generics.SampleGeneric$SampleTypeB@70dea4e
============================================================
T <java.lang.Integer> = 10
============================================================
...
public class TestMainCompare
{
	...
	public static void main(String[] args){
		TestMainCompare test = new TestMainCompare();
