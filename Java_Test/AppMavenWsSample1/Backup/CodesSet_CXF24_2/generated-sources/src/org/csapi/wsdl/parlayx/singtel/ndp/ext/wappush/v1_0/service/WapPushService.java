...
@WebServiceClient(name = "WapPushService", 
                  wsdlLocation = "file:/D:/WorkDJS/Test/JEE_Test/MavenSample2/src/main/wsdl/some_parlayx_wappush_service_1_0.wsdl",
...
public class WapPushService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/WorkDJS/Test/JEE_Test/MavenSample2/src/main/wsdl/some_parlayx_wappush_service_1_0.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WapPushService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/D:/WorkDJS/Test/JEE_Test/MavenSample2/src/main/wsdl/some_parlayx_wappush_service_1_0.wsdl");
        }
        WSDL_LOCATION = url;
    }
