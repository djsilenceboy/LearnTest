...
public class TestMain
{
	...
	public String szProxyHost = "proxy.is";
	public int iProxyPort = 80;
	public String szProxyUser = "tester";
	public String szProxyNtlmDomain = "company";
	public String szProxyNtlmUser = "tester";
	public String szProxyPassword = "P@ssword";
