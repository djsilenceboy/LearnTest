...
public class ItemDaoImplB implements ItemDao
{
	private final Logger log = Logger.getLogger( ItemDaoImplB.class );
	...
	public List<Item> query( String itemName )
	{
		...
		List items = jdbcTemplate.query( sql, parameters, new RowMapper()
		{
