...
public class ServiceException extends java.lang.Exception{
    ...
    private com.djs.learn.wsclient.wap_push.WapPushServiceStub.ServiceExceptionE faultMessage;
    ...
    public void setFaultMessage(com.djs.learn.wsclient.wap_push.WapPushServiceStub.ServiceExceptionE msg){
       faultMessage = msg;
    }
    
    public com.djs.learn.wsclient.wap_push.WapPushServiceStub.ServiceExceptionE getFaultMessage(){
       return faultMessage;
    }
}
