 ...
 * 
 */
@WebService(name = "ExtWapPush", targetNamespace = "http://www.csapi.org/wsdl/parlayx/singtel/ndp/ext/wappush/v1_0/interface")
@XmlSeeAlso({
    org.csapi.schema.parlayx.singtel.ndp.ext.wappush.v1_0.local.ObjectFactory.class,
    org.csapi.schema.parlayx.singtel.ndp.ext.wappush.v1_0.ObjectFactory.class,
...
public interface ExtWapPush {
     ...
     * @return
     *     returns org.csapi.schema.parlayx.singtel.ndp.ext.wappush.v1_0.WapPushRespData
