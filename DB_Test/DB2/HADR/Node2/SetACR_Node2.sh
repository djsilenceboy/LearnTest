...
#
# Purpose:
#   Set automatic client reroute (ACR) for Database node 2.
#
# Notice:
...
db2 -tv +p << EOF
UPDATE ALTERNATE SERVER FOR DATABASE DERDB USING HOSTNAME gpo-hc-db2-1.sdad.sl.ibm.com PORT 50000;
UPDATE ALTERNATE SERVER FOR DATABASE SCAADPDB USING HOSTNAME gpo-hc-db2-1.sdad.sl.ibm.com PORT 50000;
UPDATE ALTERNATE SERVER FOR DATABASE GPOSTRDB USING HOSTNAME gpo-hc-db2-1.sdad.sl.ibm.com PORT 50000;
EOF
