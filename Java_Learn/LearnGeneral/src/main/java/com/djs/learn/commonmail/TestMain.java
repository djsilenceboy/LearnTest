...
{
	public static final String szHostName = "EXGL06B.company.corp.root";
	public static final int iPort = -1;
	public static final String szFromAddr = "NoBody@noreply.com";
	public static final String szFromName = "Tester1";
	public static final String szToAddr = "tester2@company.com";
	public static final String szToName = "Tester2";
