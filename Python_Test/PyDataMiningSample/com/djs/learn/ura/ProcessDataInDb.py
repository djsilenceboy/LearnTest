...
def process_transaction_per_month(dbConnection):
    dataFrame = pd.read_sql_query(con = dbConnection, sql = """
SELECT a.POSTAL_DISTRICT, a.PROJECT_NAME, a.PROPERTY_TYPE, a.TENURE_YEAR, a.SALE_YEAR, a.SALE_DATE, a.TRANSACTIONS AS TRANS_ALL, b.TRANSACTIONS AS TRANS_80SQM_100W, c.TRANSACTIONS AS TRANS_60SQM_90W, d.TRANSACTIONS AS TRANS_80SQM_120W
FROM
...
def process_price_summary(dbConnection):
    dataFrame = pd.read_sql_query(con = dbConnection, sql = """
SELECT a.POSTAL_DISTRICT, a.PROJECT_NAME, a.PROPERTY_TYPE, a.TENURE_YEAR, a.FLOOR_AREA, a.TRANSACTIONS AS ALL_TRANS, a.MIN_PRICE AS ALL_MIN, a.AVG_PRICE AS ALL_AVG, a.MAX_PRICE AS ALL_MAX, b.TRANSACTIONS AS A2020_TRANS, b.MIN_PRICE AS A2020_MIN, b.AVG_PRICE AS A2020_AVG, b.MAX_PRICE AS A2020_MAX, c.TRANSACTIONS AS A2021_TRANS, c.MIN_PRICE AS A2021_MIN, c.AVG_PRICE AS A2021_AVG, c.MAX_PRICE AS A2021_MAX, d.TRANSACTIONS AS A2022_TRANS, d.MIN_PRICE AS A2022_MIN, d.AVG_PRICE AS A2022_AVG, d.MAX_PRICE AS A2022_MAX, e.TRANSACTIONS AS A2023_TRANS, e.MIN_PRICE AS A2023_MIN, e.AVG_PRICE AS A2023_AVG, e.MAX_PRICE AS A2023_MAX
FROM
