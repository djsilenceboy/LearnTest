...
SELECT a.POSTAL_DISTRICT, a.PROJECT_NAME, a.PROPERTY_TYPE, a.TENURE_YEAR, a.FLOOR_AREA,
  a.TRANSACTIONS AS ALL_TRANS, a.AVG_PRICE AS ALL_AVG, a.MIN_PRICE AS ALL_MIN, a.MAX_PRICE AS ALL_MAX,
  f.TRANSACTIONS AS Y2026_TRANS, f.AVG_PRICE AS Y2026_AVG, f.MIN_PRICE AS Y2026_MIN, f.MAX_PRICE AS Y2026_MAX,
  e.TRANSACTIONS AS Y2025_TRANS, e.AVG_PRICE AS Y2025_AVG, e.MIN_PRICE AS Y2025_MIN, e.MAX_PRICE AS Y2025_MAX,
  d.TRANSACTIONS AS Y2024_TRANS, d.AVG_PRICE AS Y2024_AVG, d.MIN_PRICE AS Y2024_MIN, d.MAX_PRICE AS Y2024_MAX,
  c.TRANSACTIONS AS Y2023_TRANS, c.AVG_PRICE AS Y2023_AVG, c.MIN_PRICE AS Y2023_MIN, c.MAX_PRICE AS Y2023_MAX,
  b.TRANSACTIONS AS Y2023_TRANS, b.AVG_PRICE AS Y2023_AVG, b.MIN_PRICE AS Y2023_MIN, b.MAX_PRICE AS Y2023_MAX
FROM
...
SELECT a.POSTAL_DISTRICT, a.PROJECT_NAME, a.PROPERTY_TYPE, a.TENURE_YEAR, a.FLOOR_AREA,
  ...
  c.TRANSACTIONS AS Y2026_TRANS, c.AVG_PRICE AS Y2026_AVG,
  CAST(ROUND(c.AVG_PRICE * 100.0 / b.AVG_PRICE - 100) AS INTEGER) AS P21_4Y, CAST(ROUND(b.AVG_PRICE * 1.21) AS INTEGER) AS P21_4Y_PRICE,
  b.TRANSACTIONS AS Y2023_TRANS, b.AVG_PRICE AS Y2023_AVG
FROM
