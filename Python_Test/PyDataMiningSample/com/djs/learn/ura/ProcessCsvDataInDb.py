...
SELECT a.POSTAL_DISTRICT, a.PROJECT_NAME, a.PROPERTY_TYPE, a.TENURE_YEAR, a.FLOOR_AREA,
  ...
  b.TRANSACTIONS AS B2023_TRANS, b.AVG_PRICE AS B2023_AVG, b.MIN_PRICE AS B2023_MIN, b.MAX_PRICE AS B2023_MAX
FROM
