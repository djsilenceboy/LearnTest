...
def process_price_rental_ratio(dbConnection):
    dataFrame = pd.read_sql_query(con = dbConnection, sql = """
SELECT a.POSTAL_DISTRICT, a.PROJECT_NAME, a.STREET_NAME, a.PROPERTY_TYPE, a.LEASE_YEAR, a.FLOOR_AREA_LOWER, b.PRICE_AVG, a.YEARLY_RENT_AVG, CAST(ROUND(b.PRICE_AVG / a.YEARLY_RENT_AVG) AS INTEGER) AS PRICE_RENT_RATIO, b.TRANSACTIONS AS SALE_TRANSACTIONS, a.TRANSACTIONS AS RENT_TRANSACTIONS
FROM
...
ORDER BY a.LEASE_YEAR, a.FLOOR_AREA_LOWER, PRICE_RENT_RATIO, b.PRICE_AVG;
    """)
    return dataFrame
