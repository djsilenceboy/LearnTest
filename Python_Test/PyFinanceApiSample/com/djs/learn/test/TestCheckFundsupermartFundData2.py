...
python CheckFinanceDataSelenium.py -d 1 -i "../../../../etc/Fundsupermart_FundInfo.csv" -o "../../../../Temp/Fundsupermart_FundData.json" -t 1 -w "D:\Download\Shared\geckodriver.exe" -l "../../../../Temp/geckodriver.log"
'''
